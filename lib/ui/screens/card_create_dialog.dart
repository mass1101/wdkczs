...
class _CardCreateDialogState extends State<CardCreateDialog> {
  ...
  String? _validateUid(String? value) {
    ...
    if (_selectedType == TagType.em4100 && clean.length != 10) {
      return 'EM4100 UID 需要 5 字节（10 位 hex）';
    }
    return null;
  }
  ...
  Future<void> _save() async {
    ...
    if (!_isLf) {
      ...
      if (_isClassic) {
        ...
        if (data.isNotEmpty) {
          final block0 = mfClassicGenerateFirstBlock(uidBytes, sak, hexToUint8List(_atqaCtrl.text));
